"""Запуск сатурации VRP_TEST — все роуты, оба устройства (CLI)."""
import sys
import os
...
log_file = os.path.join(LOG_DIR, f"run_vrp_test_{datetime.now().strftime('%Y-%m-%d_%H-%M-%S')}.log")
